...
# Conclusion
In this project, we analyzed the airbnb listings in New York on September, 2019. Our data shows 
that most of the listings are among Manhattan and Brooklyn.
We explored some interesting facts about the airbnb listings price. Most of the listings
have price under $250. However, there are some listings have extremely high price (even $1000 per night). 
Theses listings are entire home/apt with more than one bedrooms in Manhattan. 
Locations is an important factor affect price. The closer the location of the listings are to new york downtown,
the higher the price. The average price for Manhattan is almost as twice as other neighbourhoods. 
